...
public class ZLibCompressor : BaseCompressor
{
    ...
    /// </summary>
    public static ZLibCompressor Shared { get; } = new(name: "shared");
    ...
    public ZLibCompressor(string name)
    ...
    public ZLibCompressor(CompressionLevel level)
    ...
    /// <param name="name">The name.</param>
    /// <param name="level">Compression level (Defaults to <see cref="CompressionLevel.Fastest"/>)</param>
    public ZLibCompressor(string name, CompressionLevel level)
    {
        Name = name;
        Level = level;
    }
    ...
    protected override byte[] BaseCompress(byte[] bytes)
    {
        ...
        using (var brotliStream = new ZLibStream(outputStream, Level, leaveOpen: true))
        {
    ...
    protected override byte[] BaseDecompress(byte[] compressedBytes)
    {
        ...
        using var brotliStream = new ZLibStream(inputStream, CompressionMode.Decompress, leaveOpen: true);
    ...
    {
        await using (var brotliStream = new ZLibStream(outputStream, Level, leaveOpen: true))
        {
    ...
    {
        await using (var brotliStream = new ZLibStream(inputStream, CompressionMode.Decompress, leaveOpen: true))
        {
