<!-- ![Benchmark](src/EasyCompressor.png)  -->
...
<img src="src/EasyCompressor.png" width="128" height="128" align="left"/> An **Easy-to-Use** and **Optimized** compression library for .NET that unified several compression algorithms including **LZ4**, **Snappy**, **Zstd**, **LZMA**, **Brotli**, **GZip**, **ZLib**, and **Deflate**. 
