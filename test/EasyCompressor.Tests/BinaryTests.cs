...
public class BinaryTests(ICompressor compressor) : TestBase(compressor)
{
    [Test]
    public void Compress_NullValue_Should_Throws_ArgumentNullException()
    {
        void action() => Compressor.Compress(null);
    ...
    {
        void action() => Compressor.Compress([]);
    ...
    {
        void action() => Compressor.Decompress(null);
    ...
    {
        void action() => Compressor.Decompress([]);
    ...
    {
        void action() => Compressor.Compress(ObjectBytes);
    ...
    {
        var compressedBytes = Compressor.Compress(ObjectBytes);
        void action() => Compressor.Decompress(compressedBytes);
